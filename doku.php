...
<body>
	...
	<div id="laeufe" class="tabcontent">
		...
		<table>
			...
			<tr><th>Zielzeit:</th><th><?php $ergebnis = mysqli_query($link, 'SELECT 60m FROM judith WHERE prozent = "70"'); $ziele = mysqli_fetch_assoc($ergebnis); $ziel = $ziele['60m']; echo $ziel;?> sec</th><th><input name="80m" id="ziel80m"></th><th><input name="100m" id="ziel100m"></th><th><input name="120m" id="ziel120m"></th><th><input name="150m" id="ziel150m"></th><th><input name="180m" id="ziel180m"></th><th><input name="200m" id="ziel200m"></th><th><input name="250m" id="ziel250m"></th></tr>
			<tr><th>gemessen:</th><th><input name="60m" id="echt60m"></th><th><input name="80m" id="echt80m"></th><th><input name="100m" id="echt100m"></th><th><input name="120m" id="echt120m"></th><th><input name="150m" id="echt150m"></th><th><input name="180m" id="echt180m"></th><th><input name="200m" id="echt200m"></th><th><input name="250m" id="echt250m"></th></tr>
			<tr></tr>
			...
			<tr><th>gemessen:</th><th><input name="300m" id="echt300m"></th><th><input name="350m" id="echt350m"></th><th><input name="400m" id="echt400m"></th><th><input name="450m" id="echt450m"></th><th><input name="500m" id="echt500m"></th><th><input name="550m" id="echt550m"></th><th><input name="600m" id="echt600m"></th></tr>
		</table>
